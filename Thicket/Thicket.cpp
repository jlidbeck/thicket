...
// Thicket.cpp : Defines the class behaviors for the application.
//
...
// CThicketApp construction

CThicketApp::CThicketApp() noexcept
{
	...
	SetAppID(_T("Thicket.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CThicketApp object

CThicketApp theApp;


// CThicketApp initialization

BOOL CThicketApp::InitInstance()
{
...
void CThicketApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CThicketApp customization load/save methods

void CThicketApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CThicketApp::LoadCustomState()
{
}

void CThicketApp::SaveCustomState()
{
}
